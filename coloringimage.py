...
Original file is located at
    https://colab.research.google.com/drive/11M-fI9tWmGPYRDEPlHQUDvJeKMhcaWzv
"""
...
# Specify the path where you want to download and extract the ImageNet dataset
imagenet_path = untar_data(URLs.IMAGENETTE_160)

# If you want to use the full-size ImageNet dataset, you can use the following URL instead:
# imagenet_path = untar_data(URLs.IMAGENETTE)

# Convert the Path object to a string and use it for further processing
imagenet_path = str(imagenet_path)

# Now 'imagenet_path' contains the path to the ImageNet dataset
path = imagenet_path
